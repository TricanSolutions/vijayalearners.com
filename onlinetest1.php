...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
    ...
    <!-- Mirrored from theme.stepofweb.com/Atropos/v1.7/HTML/page-about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Mar 2016 13:56:58 GMT -->
    <head>
        <meta charset="utf-8" />
        <?php
                ...
                <article class="row">
                    <div class="col-md-9">
                        <!--                        <div class="owl-carousel controlls-over" data-plugin-options='{"items": 1, "singleItem": true, "navigation": true, "pagination": true, "transitionStyle":"fadeUp"}'>
                                                    <div>
                                                        <img class="img-responsive" src="assets/images/demo/about_1.jpg" width="555" height="311" alt="">
                                                    </div>
                                                    <div>
                                                        <iframe src="http://player.vimeo.com/video/23630702" width="800" height="450"></iframe>
                                                    </div>
                                                    <div>
                                                        <img class="img-responsive" src="assets/images/demo/about_2.jpg" width="555" height="311" alt="">
                                                    </div>-->
                        <!--<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Default Modal</a>-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body col-lg-12">
                                <div class="col-md-12" id="qhead">
                                     <p id="SP" style="font-size:18px"><span id="EP">(01)</span> fhfgfghfghfghfghfghfghgfhgfhffuu i,l=fKka oelafjkafka"</p>
...
<!--                                    <input type="radio" name="radio_name" value="1" class="form-control" checked="checked" /><strong>test1efvvfvrvtrvrtvtrvtrv</strong> <br>
                                    <input type="radio" name="radio_name" value="1" class="form-control" checked="" /><strong>test2vrecfsdj6unbrtvecyb5rtv</strong> <br>
                                    <input type="radio" name="radio_name" value="1" class="form-control" checked="" /><strong>test3   ybrtverc</strong> <br>
                                    <input type="radio" name="radio_name" value="1" class="form-control" checked="" /><strong>test4tgverc tgrevcex gvrecxs trvfdcsdx tvfscd</strong> -->
                                    <br>
                                    <p></p>
                            ...
                            <div class="modal-footer"><!-- modal footer -->
                                <button class="btn btn-default" data-dismiss="modal">Close</button> <button class="btn btn-primary">Next</button>
                            </div><!-- /modal footer -->
...
function myFunction(arr) {
    ...
    for(i = 0; i<arr.length; i++) {
        out += '<br><input type="radio" name="radio_name" value="1" class="form-control" checked="" />'+'<a href="' + arr[i].url + '">' + arr[i].display + '</a><br>';
    }
    document.getElementById("id01").innerHTML = out;
//    document.getElementById('qhead').innerHTML= question[0].Q1;
}
</script>
...
<script src="controllers/questions.js"></script>
    ...
    <!-- Mirrored from theme.stepofweb.com/Atropos/v1.7/HTML/page-about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Mar 2016 13:57:22 GMT -->
</html>